...
POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(host dir_joined dir_writable_joined root_indicator_joined vcs_joined vi_mode_joined)
POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(status virtualenv anaconda rust_version nvm aws terraform background_jobs_joined time_joined battery-joined)
...
POWERLEVEL9K_RUST_VERSION_BACKGROUND='clear'
POWERLEVEL9K_RUST_VERSION_FOREGROUND='yellow'
