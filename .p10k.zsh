# Generated by Powerlevel10k configuration wizard on 2020-08-20 at 09:43 CDT.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 20659.
# Wizard options: nerdfont-complete + powerline, small icons, unicode, lean, 24h time,
# 2 lines, disconnected, left frame, darkest-ornaments, sparse, many icons, concise,
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_SRCCODE_VISUAL_IDENTIFIER_EXPANSION=''
  typeset -g POWERLEVEL9K_DIR_SRCCODE_FOREGROUND=31
  typeset -g POWERLEVEL9K_DIR_SRCCODE_SHORTENED_FOREGROUND=103
  typeset -g POWERLEVEL9K_DIR_SRCCODE_ANCHOR_FOREGROUND=39
  ...
  typeset -g POWERLEVEL9K_VIRTUALENV_FOREGROUND='deepskyblue2'
  ...
  typeset -g POWERLEVEL9K_ANACONDA_FOREGROUND='deepskyblue2'
  ...
  typeset -g POWERLEVEL9K_TERRAFORM_CLASSES=(
       '*glgapp*'     PROD    # These values are examples that are unlikely
       '*prototype*'  PROTO    # to match your needs. Customize them as needed.
      '*'         OTHER)
  typeset -g POWERLEVEL9K_TERRAFORM_OTHER_FOREGROUND=38
  typeset -g POWERLEVEL9K_TERRAFORM_GLGAPP_FOREGROUND='red'
  typeset -g POWERLEVEL9K_TERRAFORM_PROTO_FOREGROUND='blue'
